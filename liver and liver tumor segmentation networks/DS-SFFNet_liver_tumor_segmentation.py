        ...
        with slim.arg_scope([slim.conv2d, slim.max_pool2d],
            ...
            with slim.arg_scope([slim.conv2d],
                ...
                with slim.arg_scope([slim.convolution2d_transpose],
                    ...
                    add_up_1 = tf.add(side_4_br_sum, side_5_up, name='add_up_1')
                    ...
                    add_up_2 = tf.add(side_3_br_sum, side_4_up, name='add_up_2')
                    ...
                    add_up_3 = tf.add(side_2_br_sum, side_3_up, name='add_up_3')
...
def parameter_lr():
    ...
    vars_corresp['seg_liver/side_2_br_1/weights'] = 1
    vars_corresp['seg_liver/side_2_br_1/biases'] = 2
    vars_corresp['seg_liver/side_2_br_2/weights'] = 1
    vars_corresp['seg_liver/side_2_br_2/biases'] = 2
    
    vars_corresp['seg_liver/side_3_br_1/weights'] = 1
    vars_corresp['seg_liver/side_3_br_1/biases'] = 2
    vars_corresp['seg_liver/side_3_br_2/weights'] = 1
    vars_corresp['seg_liver/side_3_br_2/biases'] = 2    
    
    vars_corresp['seg_liver/side_4_br_1/weights'] = 1
    vars_corresp['seg_liver/side_4_br_1/biases'] = 2
    vars_corresp['seg_liver/side_4_br_2/weights'] = 1
    vars_corresp['seg_liver/side_4_br_2/biases'] = 2 
    
    vars_corresp['seg_liver/side_5_br_1/weights'] = 1
    vars_corresp['seg_liver/side_5_br_1/biases'] = 2
    vars_corresp['seg_liver/side_5_br_2/weights'] = 1
    vars_corresp['seg_liver/side_5_br_2/biases'] = 2
    
    vars_corresp['seg_liver/add_up_1_br_1/weights'] = 1
    vars_corresp['seg_liver/add_up_1_br_1/biases'] = 2
    vars_corresp['seg_liver/add_up_1_br_2/weights'] = 1
    vars_corresp['seg_liver/add_up_1_br_2/biases'] = 2   
    
    vars_corresp['seg_liver/add_up_2_br_1/weights'] = 1
    vars_corresp['seg_liver/add_up_2_br_1/biases'] = 2
    vars_corresp['seg_liver/add_up_2_br_2/weights'] = 1
    vars_corresp['seg_liver/add_up_2_br_2/biases'] = 2  
...
def _train(dataset, initial_ckpt, supervison, learning_rate, logs_path, max_training_iters, save_step, display_step,
    ...
    with tf.name_scope('losses'):
        ...
        tf.summary.scalar('losses/total_loss_0.001', total_loss)
