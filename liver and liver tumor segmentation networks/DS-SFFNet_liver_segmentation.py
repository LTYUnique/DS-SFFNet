"""
Codes from Miriam Bellver (miriam.bellver@bsc.es).
LTYUnique modified it.
"""
    ...
    with tf.variable_scope(scope, 'seg_lesion', [inputs]) as sc:
        ...
        with slim.arg_scope([slim.conv2d, slim.max_pool2d],
            ...
            with slim.arg_scope([slim.conv2d],padding='SAME',
                ...
                side_2_br_1 = slim.conv2d(side_2, 16, [3,3], activation_fn=tf.nn.relu, scope='side_2_br_1') 
                side_2_br_2 = slim.conv2d(side_2_br_1, 16, [3, 3], scope='side_2_br_2')
                side_2_br_sigmod = tf.nn.sigmoid(side_2_br_2, 'side_2_br_sigmod')
                side_2_br_multiply = tf.multiply(side_2, side_2_br_sigmod)
                side_2_br_sum = tf.add(side_2, side_2_br_multiply, name='side_2_br_sum')
                
                side_3 = slim.conv2d(net_3, 16, [3, 3], scope='conv3_3_16')
                side_3_br_1 = slim.conv2d(side_3, 16, [3,3], activation_fn=tf.nn.relu, scope='side_3_br_1')
                side_3_br_2 = slim.conv2d(side_3_br_1, 16, [3, 3], scope='side_3_br_2')
                side_3_br_sigmod = tf.nn.sigmoid(side_3_br_2, 'side_3_br_sigmod')
                side_3_br_multiply = tf.multiply(side_3, side_3_br_sigmod)
                side_3_br_sum = tf.add(side_3, side_3_br_multiply, name='side_3_br_sum')
                
                side_4 = slim.conv2d(net_4, 16, [3, 3], scope='conv4_3_16')
                side_4_br_1 = slim.conv2d(side_4, 16, [3,3], activation_fn=tf.nn.relu, scope='side_4_br_1')
                side_4_br_2 = slim.conv2d(side_4_br_1, 16, [3, 3], scope='side_4_br_2')
                side_4_br_sigmod = tf.nn.sigmoid(side_4_br_2, 'side_4_br_sigmod')
                side_4_br_multiply = tf.multiply(side_4, side_4_br_sigmod)
                side_4_br_sum = tf.add(side_4, side_4_br_multiply, name='side_4_br_sum')
                
                side_5 = slim.conv2d(net_5, 16, [3, 3], scope='conv5_3_16')
                side_5_br_1 = slim.conv2d(side_5, 16, [3,3], activation_fn=tf.nn.relu, scope='side_5_br_1')
                side_5_br_2 = slim.conv2d(side_5_br_1, 16, [3, 3], scope='side_5_br_2')
                side_5_br_sigmod = tf.nn.sigmoid(side_5_br_2, 'side_5_br_sigmod')
                side_5_br_multiply = tf.multiply(side_5, side_5_br_sigmod)
                side_5_br_sum = tf.add(side_5, side_5_br_multiply, name='side_5_br_sum')

            with slim.arg_scope([slim.convolution2d_transpose],
                                activation_fn=None, biases_initializer=None, padding='SAME',
                                outputs_collections=end_points_collection, trainable=False):
                
                side_5_up = slim.convolution2d_transpose(side_5_br_sum, 16, 3, 2, scope='side_5_up')
                side_4_size = tf.shape(side_4_br_sum)
                side_5_up_crop = crop_features(side_5_up, side_4_size)
                add_up_1 = tf.add(side_4_br_sum, side_5_up_crop, name='add_up_1')
                
                add_up_1_br_1 = slim.conv2d(add_up_1, 16, [3,3], activation_fn=tf.nn.relu, scope='add_up_1_br_1')
                add_up_1_br_2 = slim.conv2d(add_up_1_br_1, 16, [3, 3], scope='add_up_1_br_2')
                add_up_1_br_sigmod = tf.nn.sigmoid(add_up_1_br_2, 'add_up_1_br_sigmod')
                add_up_1_br_multiply = tf.multiply(add_up_1, add_up_1_br_sigmod)
                add_up_1_br_sum = tf.add(add_up_1, add_up_1_br_multiply, name='add_up_1_br_sum')
                
                side_4_up = slim.convolution2d_transpose(add_up_1_br_sum, 16, 3, 2, scope='side_4_up')
                side_3_size = tf.shape(side_3_br_sum)
                side_4_up_crop = crop_features(side_4_up, side_3_size)
                add_up_2 = tf.add(side_3_br_sum, side_4_up_crop, name='add_up_2')
                
                add_up_2_br_1 = slim.conv2d(add_up_2, 16, [3,3], activation_fn=tf.nn.relu, scope='add_up_2_br_1')
                add_up_2_br_2 = slim.conv2d(add_up_2_br_1, 16, [3, 3], scope='add_up_2_br_2')
                add_up_2_br_sigmod = tf.nn.sigmoid(add_up_2_br_2, 'add_up_2_br_sigmod')
                add_up_2_br_multiply = tf.multiply(add_up_2, add_up_2_br_sigmod)
                add_up_2_br_sum = tf.add(add_up_2, add_up_2_br_multiply, name='add_up_2_br_sum')
                
                side_3_up = slim.convolution2d_transpose(add_up_2_br_sum, 16, 3, 2, scope='side_3_up')
                side_2_size = tf.shape(side_2_br_sum)
                side_3_up_crop = crop_features(side_3_up, side_2_size)
                add_up_3 = tf.add(side_2_br_sum, side_3_up_crop, name='add_up_3')               
                
                

                # Supervise side outputs
                side_2_s = slim.conv2d(add_up_3, number_slices, [1, 1], scope='score-dsn_2')
                side_3_s = slim.conv2d(add_up_2, number_slices, [1, 1], scope='score-dsn_3')
                side_4_s = slim.conv2d(add_up_1, number_slices, [1, 1], scope='score-dsn_4')
                ...
                with slim.arg_scope([slim.convolution2d_transpose],
                    ...
                    # Main output
                    side_2_f = slim.convolution2d_transpose(add_up_3, 16, 4, 2, scope='score-multi2-up')
                    ...
                    side_3_f = slim.convolution2d_transpose(add_up_2, 16, 8, 4, scope='score-multi3-up')
                    ...
                    side_4_f = slim.convolution2d_transpose(add_up_1, 16, 16, 8, scope='score-multi4-up')
...
def parameter_lr():
    ...
    vars_corresp['seg_lesion/side_2_br_1/weights'] = 1
    vars_corresp['seg_lesion/side_2_br_1/biases'] = 2
    vars_corresp['seg_lesion/side_2_br_2/weights'] = 1
    vars_corresp['seg_lesion/side_2_br_2/biases'] = 2
    
    vars_corresp['seg_lesion/side_3_br_1/weights'] = 1
    vars_corresp['seg_lesion/side_3_br_1/biases'] = 2
    vars_corresp['seg_lesion/side_3_br_2/weights'] = 1
    vars_corresp['seg_lesion/side_3_br_2/biases'] = 2    
    
    vars_corresp['seg_lesion/side_4_br_1/weights'] = 1
    vars_corresp['seg_lesion/side_4_br_1/biases'] = 2
    vars_corresp['seg_lesion/side_4_br_2/weights'] = 1
    vars_corresp['seg_lesion/side_4_br_2/biases'] = 2 
    
    vars_corresp['seg_lesion/side_5_br_1/weights'] = 1
    vars_corresp['seg_lesion/side_5_br_1/biases'] = 2
    vars_corresp['seg_lesion/side_5_br_2/weights'] = 1
    vars_corresp['seg_lesion/side_5_br_2/biases'] = 2
    
    vars_corresp['seg_lesion/add_up_1_br_1/weights'] = 1
    vars_corresp['seg_lesion/add_up_1_br_1/biases'] = 2
    vars_corresp['seg_lesion/add_up_1_br_2/weights'] = 1
    vars_corresp['seg_lesion/add_up_1_br_2/biases'] = 2   
    
    vars_corresp['seg_lesion/add_up_2_br_1/weights'] = 1
    vars_corresp['seg_lesion/add_up_2_br_1/biases'] = 2
    vars_corresp['seg_lesion/add_up_2_br_2/weights'] = 1
    vars_corresp['seg_lesion/add_up_2_br_2/biases'] = 2  
